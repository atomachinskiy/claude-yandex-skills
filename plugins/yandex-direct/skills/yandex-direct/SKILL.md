...
name: yandex-direct
description: |
  Контекстная реклама Яндекс.Директ: кампании, объявления, отчёты, ставки, ОРД-документы.
  Использует общий OAuth-токен Яндекса (плагин yandex-auth). Cache-first,
  лимит stdout 30 строк по умолчанию.
  Triggers: yandex-direct, direct, яндекс direct.
---
...
Scope в OAuth-приложении: `direct:api`.
...
База: `https://api.direct.yandex.com/json/v5`
