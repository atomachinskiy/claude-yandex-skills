---
name: yandex-360-admin
description: |
  Админ-API Яндекс 360: пользователи, домены, аудит, настройки организации.
  Использует общий OAuth-токен Яндекса (плагин yandex-auth). Cache-first,
  лимит stdout 30 строк по умолчанию.
  Triggers: yandex-360-admin, 360-admin, яндекс 360-admin.
---
...
Scope в OAuth-приложении: `directory:full`.
